...
describe('BlogCard', () => {
  ...
  it('should render category badge', () => {
    ...
    expect(screen.getAllByText('algorithms')[0]).toBeInTheDocument()
  })
  ...
  it('should render tags', () => {
    ...
    expect(screen.getAllByText('algorithms')).toHaveLength(2) // Once as category, once as tag
  })
  ...
  it('should handle featured posts', () => {
    ...
    // Featured posts are rendered normally (no special UI indication in current implementation)
  ...
  it('should handle different locales', () => {
    ...
    render(<BlogCard post={zhPost} />, { locale: 'zh-Hans' })
